...
\begincols
\column{0.48\textwidth} \input{figures/model.tex}
...
\hfill\column{1\textwidth} \input{figures/model.tex} \stopcols
...
\hfill\column{0.55\textwidth} \stopcols
...
\tightlist
\item
  Processus écologiques X aménagement forestier X changement climatique
\item
  Intégration des processus à différentes échelles spatiales
\item
